...
public class StatusBarUtils {
    ...
    private static int getStatusBarHeight(Activity acitivity) {
        ...
        Log.e("getStatusBarHeight", acitivity.getResources().getDimensionPixelOffset(resourceId) + "");
        return acitivity.getResources().getDimensionPixelSize(resourceId);
    }
     ...
     * @return
     */
    private static int getStatusBarHeight2(Activity acitivity) {
        ...
        try {
            ...
            int height = Integer.parseInt(clazz.getField("status_bar_height")
                    .get(object).toString());
            statusBarHeight2 = acitivity.getResources().getDimensionPixelSize(height);
        } catch (Exception e) {
            e.printStackTrace();
        }
        Log.e("getStatusBarHeight2", statusBarHeight2 + "");
